...
import LoadingButton, { FullPageLoader } from '../components/LoadingButton';
...
const StartMatch = () => {
  ...
  if (loading) return <FullPageLoader message="SCANNING FOR AGENTS..." />;
      ...
      <div className="card">
        <form onSubmit={handleStart} style={{ display: 'grid', gap: '25px' }}>
          ...
          <LoadingButton 
            type="submit" 
            loading={submitting}
            disabled={!agentW || !agentB || agentW === agentB}
